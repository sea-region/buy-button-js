...
var Product = function () {
  ...
  _createClass(Product, [{
    ...
    key: "templates",
    value: function templates(data) {
      return {
        title: "<h2>" + data.title + "</h2>",
        button: function button(onclick) {
          return (0, _yoYo2.default)(_templateObject, onclick.bind(this));
        }
      };
    }
  }, {
...
var Cart = function () {
  ...
  _createClass(Cart, [{
    ...
    value: function addItem(item) {
      ...
      var newDom = this.render();
      _yoYo2.default.update(this.dom, newDom);
    }
  }, {
    key: "render",
    value: function render() {
      return (0, _yoYo2.default)(_templateObject3, this.data.lineItems.map(function (item) {
        return (0, _yoYo2.default)(_templateObject4, item.title);
      }));
    }
  }]);
...
var UI = function () {
  ...
  _createClass(UI, [{
    key: "createProduct",
    value: function createProduct(props) {
      var product = new Product(Object.assign({}, props, { onclick: this.addToCart.bind(this) }));
    }
  }, {
    key: "addToCart",
